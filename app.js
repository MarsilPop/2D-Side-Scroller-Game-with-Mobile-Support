window.addEventListener('load', function() {
    ...
    class InputHandler {
        constructor() {
            ...
            window.addEventListener('touchmove', e => {
                ...
                if (swipteDistance < -this.touchTreshold && this.keys.indexOf('swipe up') === -1) this.keys.push('swipe up');
                else if (swipteDistance > this.touchTreshold && this.keys.indexOf('swipe down') === -1) {
    ...
    function displayStatusText(context) {
        // ! in Firefox built in canvas shadow prop causes frame rate issues
